...
data_users = pd.read_csv(
    "C:/Users/soghr/ML_Project/valid_users.csv")
data_sessions = pd.read_csv(
    "C:/Users/soghr/ML_Project/Elena_suggested_sessions.csv")
data_flights = pd.read_csv(
    "C:/Users/soghr/ML_Project/valid_flights.csv")
data_hotels = pd.read_csv(
    "C:/Users/soghr/ML_Project/valid_hotels.csv")
####################
